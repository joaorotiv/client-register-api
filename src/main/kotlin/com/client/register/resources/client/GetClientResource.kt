...
import com.client.register.services.client.GetClientService
...
class GetClientResource(
    ...
    @Operation(summary = "Get filtered list of clients", description = "Método para listar clientes filtrados e paginados")
    @GetMapping("/filtered")
