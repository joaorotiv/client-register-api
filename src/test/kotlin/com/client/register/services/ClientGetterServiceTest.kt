...
class ClientGetterServiceTest {
    ...
    @Mock
    lateinit var repository: GetClientRepository
    ...
    @Test
    fun `should throw NotFoundException while trying to get non-existent client by Name`() {
        val name = ""
    ...
    fun `should successfully get a list of filtered clients`() {
        val clients = listOf(
            ClientEntity(1, "Jorge Alves", "jorgealves@example.com", ClientType.FISICO, ClientDocumentType.CPF,"123.456.789-01", "Rua 1 Centro", true),
            ClientEntity(2, "Joana Maria", "joanamaria@example.com",  ClientType.FISICO, ClientDocumentType.CPF, "987.654.321-09", "Rua 2 Centro", true)
        )
